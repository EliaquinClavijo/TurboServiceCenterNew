     ...
     function myFunction() {
        ...
        xmlhttp.onreadystatechange=function() { 
            if (this.readyState==4 && this.status==200) {
                ...
                if (x!=null) {
                    if(x.$reclamos!=null  ){
                        document.getElementById("reclamos").innerHTML = x.$reclamos.estado;
                   
                    }
                    if (x.$obse!= null) {
                        document.getElementById("observaciones").innerHTML = x.$obse.nro_reclamos;
                    }
                ...
                xmlhttp.open("GET","/recuperarnro",true);
                xmlhttp.send();
                }
</script>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{url('observaciones')}}"><img src="https://img.icons8.com/color/48/000000/info-popup.png"> observaciones &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong id="observaciones" align="right" style="color: red;"></strong></a>
                        </li>
                        <li>
                            <a href="{{url('reclamos')}}"><img src="https://img.icons8.com/color/48/000000/expired.png"> reclamos &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong id="reclamos" align="right" style="color: red;"></strong></a>
                        </li>
                                <li>
