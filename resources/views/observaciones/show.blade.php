  ...
  <tr>
    ...
    <th class="" style="width:80%; border:0px;"> 
      ...
      <tr style="" >
        ...
        <td class="" style="text-align:left;width:20%;font-size: 10pt;">PLACA :<span style="font-size: 10pt;color: #424949;"> {{"   "}}{{$ser->placa}} </span></td>F
      </tr>
      <tr>
        <td class="" style="text-align:left; width:25%;">MOTOR :<span style="font-size: 10pt;color: #424949;">  {{"  "}}{{$ser->motor}}</span></td>
...
<table  class="table5" align="center" style="margin-top:-2px;">
    <tbody>
      ...
      <tr class="table5-2">
        <td align="center" style="width: 10%;border: 0;"><span  style="font-weight:bold"></span></td>
        <td align="left" style="width: 60%;border: 0;"><span style="font-weight:bold; padding-left:30px;"> </span></td>
...
<table  class="table5" align="center" style="margin-top:-2px;">
    <tbody>
      ...
      <tr class="table5-2">
        <td align="center" style="width: 10%;border: 0px;"><span  style="font-weight:bold"></span></td>
        <td align="center" style="width: 70%;"><span style="font-weight:bold; padding-left:30px;color: #424949;"> {{$ser->text}}</span></td>
        <td align="center" style="width: 10%;border: 0px;"><span style="font-weight:bold"></span></td>
        <td style="width: 10%;border: 0px;"><span style="font-weight:bold"></span></td>
      </tr>
