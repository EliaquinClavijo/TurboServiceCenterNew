			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="register" align="center" >
						<form role="form" method="post" action="/turbos/{{@$turbo->idturbo}}" autocomplete="false" accept-charset="UTF-8" enctype="multipart/form-data" >
						{!! method_field('PUT')!!}
				            ...
				            $obj1 = json_decode($turbo->modelos);
				            $obj2 = json_decode($turbo->motores);
				            ?>

				            
							<h3>Agregar Data al  Turbo {{$turbo->name}}</h3>
    						...
    						<div class="col-lg-4">
					    		<table  style="undefined;table-layout: fixed; width: 100%">
									...
									<col style="width: 55%">
									  ...
									  <tr>
									    <td class="tg-quj4" align="center"  colspan="2"><label>Marcas Actuales</label></td>
									  ...
									  @foreach ($obj as $k=>$v)
									  	@if(!$k=="")
                                        <tr>
                                            <td  align="center"><hr  width="300">{{$count}}</td>
                                             <td class="tg-xldj" colspan="2"><hr  width="50"> <input type="text" class="form-control" name="marcas[]" value="{{$v}}"></td>
							...
							<div class="col-lg-4">
					    		<table  style="undefined;table-layout: fixed; width: 100%">
									...
									<col style="width: 55%">
									  ...
									  <tr>
									    <td class="tg-quj4" align="center"  colspan="2"><label>Modelos Actuales</label></td>
									  ...
									  @foreach ($obj1 as $k=>$v)
									  		@if(!$k=="")
                                        <tr>
                                            <td  align="center"><hr  width="350">{{$count}}</td>
                                             <td class="tg-xldj" colspan="2"><hr  width="50"> <input type="text" class="form-control" name="modelos[]" value="{{$v}}"></td>
							...
							<div class="col-lg-4">
					    		<table  style="undefined;table-layout: fixed; width: 100%">
									...
									<col style="width: 55%">
									  ...
									  <tr>
									    <td class="tg-quj4" align="center"  colspan="2"><label>Motores Actuales</label></td>
									  ...
									  @foreach ($obj2 as $k=>$v)
                                        ...
                                        <tr>
                                            <td  align="center"><hr  width="350">{{$count}}</td>
                                            <td class="tg-xldj" colspan="2"><hr  width="50"> <input type="text" class="form-control" name="motores[]" value="{{$v}}"></td>
