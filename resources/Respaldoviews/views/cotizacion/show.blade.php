  ...
  <tr>
    ...
    <th  style="width:30%; border:0px;"> 
    	...
    	<table class="proforma" align="center" style="width:95%;  margin-top:10px;">
		  <tr>
		    <th class="" style="background-color:#9F9E9E;" align="center"><span style="color: #ffffff;">PROFORMA</span></th>
		  </tr>
		  <tr>
...
<table class="Parte1" align="center">
  <tr>
    ...
    <th class="" style="width:80%; border:0px;"> 
        ...
        <td class="" style="text-align:left;width:20%;"><span style="font-size: 10pt;">PLACA : {{"   "}}{{$ser->placa}} </span></td>
		  </tr>
		  <tr>
